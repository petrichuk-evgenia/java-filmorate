...
public class FilmControllerTests extends BaseTest {
    ...
    public void addValidFilmTest() throws IOException, InterruptedException {
        Film filmToAdd = Film.builder()
                .name("1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111")
    ...
    public void updateValidFilmTest() throws IOException, InterruptedException {
        ...
        Film filmToUpdate = addedFilm.toBuilder().name("1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111")
    ...
    @Test
    public void addInvalidFilmNameTest() throws IOException, InterruptedException {
        Film filmToAdd = Film.builder()
                .name("111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111")
        ...
        Assert.assertEquals(resp.statusCode(), 400, "Статус POST /films должен быть 400");
        Assert.assertTrue(response.getError().equals("Ошибка валидации"), "Валидация прошла некорректно");
        Assert.assertTrue(response.getDetails().contains("Название фильма не должно быть больше 200 символов"));
    }
    ...
    @Test
    public void updateInvalidFilmNameTest() throws IOException, InterruptedException {
        Film filmToAdd = Film.builder()
                .name("1")
                .releaseDate(LocalDate.of(2025, 1, 1))
                .duration(1.5)
